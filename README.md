...
- 🔭 Building **agentic RAG systems** and **AI-powered applications**
- 🌱 Exploring **LLM agents, tool use, and orchestration**
...
[![](https://skillicons.dev/icons?i=python,typescript,cs,dotnet,react,nextjs,tailwind,postgres,redis,docker,cloudflare&perline=15)](https://skillicons.dev)
